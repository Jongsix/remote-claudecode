...
if [ -f "C:/Users/admin/go/bin/moai" ]; then
	exec "C:/Users/admin/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "C:/Users/admin/.local/bin/moai" ]; then
	exec "C:/Users/admin/.local/bin/moai" statusline < "$temp_file"
fi
